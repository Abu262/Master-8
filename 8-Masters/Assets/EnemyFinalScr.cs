...
public class EnemyFinalScr : EnemyScr
{
    ...
    void Start()
    {
        ...
        HC = GM.HeadList[12];
        TC = GM.TorsoList[12];
        WrC = GM.WeaponRList[9];
        WlC = GM.WeaponLList[9];
    ...
    IEnumerator Reload()
    {
        ...
        if (GM.onFinalLevel1 == false && (!(GM.slainEnemies == 2 || GM.slainEnemies == 6) || GM.statusE[ID] == true))
        {
